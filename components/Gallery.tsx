...
const Gallery: React.FC = () => {
  ...
  const renderTrack = () => (
    <div className="flex gap-4 md:gap-6 px-2 md:px-3 shrink-0">
      {[...galleryImages, ...galleryImages, ...galleryImages].map((imgSrc, index) => (
  ...
  return (
    <div className="bg-white py-8 md:py-12 border-b-4 border-black overflow-hidden flex" id="gallery">
